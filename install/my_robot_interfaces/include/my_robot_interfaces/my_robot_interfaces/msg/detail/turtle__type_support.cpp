...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Turtle_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::Turtle, structure_needs_at_least_one_member),  // bytes offset in struct
